...
public class DevotionScreenHandlers {
	...
	//-----Screen Handlers-----//
	public static final ScreenHandlerType<ResearchScreenHandler> RESEARCH_SCREEN_HANDLER = create("research_screen_handler", new ScreenHandlerType<>(ResearchScreenHandler::new));
