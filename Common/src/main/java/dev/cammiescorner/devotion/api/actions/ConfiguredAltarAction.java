...
public abstract class ConfiguredAltarAction {
	public static final Codec<Holder<ConfiguredAltarAction>> CODEC = RegistryFixedCodec.create(DevotionRegistryKeys.CONFIGURED_ALTAR_ACTION);
	public static final Codec<ConfiguredAltarAction> DIRECT_CODEC = DevotionRegistries.ALTAR_ACTIONS.byNameCodec().dispatch(ConfiguredAltarAction::getAltarAction, AltarAction::codec);
	public static final StreamCodec<RegistryFriendlyByteBuf, ConfiguredAltarAction> OBJ_STREAM_CODEC = ByteBufCodecs.registry(DevotionRegistryKeys.CONFIGURED_ALTAR_ACTION);
	public static final StreamCodec<RegistryFriendlyByteBuf, Holder<ConfiguredAltarAction>> HOLDER_STREAM_CODEC = ByteBufCodecs.holderRegistry(DevotionRegistryKeys.CONFIGURED_ALTAR_ACTION);
