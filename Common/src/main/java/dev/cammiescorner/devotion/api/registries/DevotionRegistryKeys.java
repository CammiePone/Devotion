...
public class DevotionRegistryKeys {
	public static final ResourceKey<Registry<WandCore>> WAND_CORE = ResourceKey.createRegistryKey(Devotion.id("wand_core"));
	public static final ResourceKey<Registry<WandCap>> WAND_CAP = ResourceKey.createRegistryKey(Devotion.id("wand_cap"));
