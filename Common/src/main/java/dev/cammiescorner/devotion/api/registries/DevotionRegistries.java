...
public class DevotionRegistries {
	...
	public static final ResourceKey<Registry<BookEntry>> BOOK_ENTRY = ResourceKey.createRegistryKey(Devotion.id("book_entries"));
	public static final ResourceKey<Registry<BookPage>> BOOK_PAGE = ResourceKey.createRegistryKey(Devotion.id("book_pages"));
